...
<p align="center">
  <!-- Android Studio -->
  <a href="https://es.wikipedia.org/wiki/Android_Studio" target="_blank">
  ...
  <!-- .NET -->
  <a href="https://es.wikipedia.org/wiki/.NET" target="_blank">
  ...
  <!-- SQLite -->
  <a href="https://es.wikipedia.org/wiki/SQLite" target="_blank">
  ...
  <!-- Docker -->
  <a href="https://es.wikipedia.org/wiki/Docker" target="_blank">
    <img src="https://skillicons.dev/icons?i=docker" alt="Docker"/>
  </a>
  <!-- Eclipse -->
  <a href="https://es.wikipedia.org/wiki/Eclipse_Inc." target="_blank">
  ...
  <!-- Linux -->
  <a href="https://es.wikipedia.org/wiki/Linux" target="_blank">
    <img src="https://skillicons.dev/icons?i=linux" alt="Linux"/>
  </a>
  <!-- PowerShell -->
  <a href="https://es.wikipedia.org/wiki/PowerShell" target="_blank">
